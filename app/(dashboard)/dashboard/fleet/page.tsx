  ...
  if (!orgId) {
    return (
      <div className="p-6 md:p-8">
        <h1 className="text-2xl font-bold text-soft-cloud mb-2">Fleet</h1>
  ...
  return (
    <div className="p-6 md:p-8 max-w-5xl">
      ...
      <p className="text-soft-cloud/70 mb-6">
        Add vehicles and assign drivers. Unassigned drivers appear in the Pool; archive or reactivate as needed.
      </p>
      <FleetClient
        orgId={orgId}
        drivers={driverList}
